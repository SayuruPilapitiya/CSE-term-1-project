...
import { X, MapPin, User, Calendar, Tag, AlertCircle, Phone, Book } from 'lucide-react';
...
export default function BookDetailsDrawer({ book, isOpen, onClose }: BookDetailsDrawerProps) {
    ...
    useEffect(() => {
        ...
        return () => {
            ...
            // Reset seller details state when drawer closes
            if (!isOpen) setShowSellerDetails(false);
        };
    }, [isOpen, onClose, showSellerDetails]);
                ...
                >
                    ...
                    <div className="p-5 border-t border-gray-100 bg-gray-50">
                        <button
                            ...
                            className="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3.5 px-4 rounded-xl shadow-lg shadow-blue-200 transition-all flex items-center justify-center transform hover:scale-[1.02] active:scale-[0.98]"
                        >
